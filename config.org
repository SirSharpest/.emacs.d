...
#+BEGIN_SRC emacs-lisp
  ...
  (setq reftex-default-bibliography '("~/Documents/PHD/library.bib"))
  (setq org-ref-default-bibliography '("~/Documents/PHD/library.bib"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun phd-diary ()
    ...
    (interactive)
    (find-file  (concat "~/Documents/PHD/Notes/" (format-time-string "phd-diary-%Y-%B-%W.org" )))
    (insert
     (format
      "#+TITLE: %s
  ,#+AUTHOR: Nathan Hughes
  ...
  (defun friday-talks ()
    "This function can be used to create an org file with today as it's file name."
    (interactive)
    (find-file  (concat "~/Documents/PHD/Notes/" (format-time-string "friday-seminar-%Y-%B-%W.org" ))))
